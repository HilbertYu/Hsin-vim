...
if has('gui_running')
    ...
    hi ErrorMsg       gui=NONE   guifg=black     guibg=darkred
    ...
    hi Folded         gui=NONE   guifg=#aaa400   guibg=#191919
    ...
    hi ErrorMsg       term=standout ctermfg=black ctermbg=darkred
    ...
    hi Folded         term=standout ctermfg=142 ctermbg=234
